...
export function DeleteExpenseCategoryButton({ id, name }: { id: number; name: string }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to delete "${name}"? Categories used by existing expenses can't be deleted.`}
      />
    </>
  )
}
